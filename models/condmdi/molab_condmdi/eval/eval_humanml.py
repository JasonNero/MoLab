...
if __name__ == '__main__':
    ...
    full_inpaint = "_full_inp" if args.full_traj_inpaint else ""
    ...
    log_file = os.path.join(os.path.dirname(args.model_path),
                            'eval_humanml{}_{}_{}'.format(full_inpaint, name, niter))
    save_dir = os.path.join(os.path.dirname(args.model_path), f'eval{full_inpaint}_{niter}')
    print('> Saving the generated motion to {}'.format(save_dir))
    print('> Inpainting full trajectory: {}'.format(args.full_traj_inpaint))
